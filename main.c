        ...
        do{
            ...
            if(vet[linha][coluna]=='*'){ // Mar.
                ...
                for(int i=linha-3;i<=linha+3&&TamanhoEspiao1<6&&contador>0;i++){ // Vertical.
                    ...
                    if(AcertosPossiveis==4||ErrosPossiveis==4){
                        break;
                    }
                }
                ...
                if(AcertosPossiveis==3&&ErrosPossiveis==4){
                    int Caso;
                    if(vet[linha-1][coluna]=='3'&&vet[linha+1][coluna]!='3'){
                        Caso = 1;
                    }
                    else if(vet[linha-1][coluna]=='3'&&vet[linha+1][coluna]=='3'){
                        Caso = 2;
                    }
                    else if(vet[linha-1][coluna]!='3'&&vet[linha+1][coluna]=='3'){
                        Caso = 3;
                ...
                if(AcertosPossiveis==3&&ErrosPossiveis==4){
                    int Caso;
                    if(vet[linha][coluna-1]=='3'&&vet[linha][coluna+1]!='3'){
                        Caso = 1;
                    }
                    else if(vet[linha][coluna-1]!='3'&&vet[linha][coluna+1]=='3'){
                        Caso = 2;
                    }
                    if(Caso==1){
                        for(int j=coluna-1;j<=coluna-1&&TamanhoEspiao1<6&&contador>0;j++){
                        ...
                        for(int j=coluna-1;j<=coluna-1&&TamanhoEspiao1<6&&contador>0;j++){
                            for(int i=linha+1;i<=linha+3&&TamanhoEspiao1<6&&contador>0;i++){
                                if(i<0 || i>=TAM || j<0 || j>=TAM){
                                    ErrosPossiveis++;
                                }
                                if(i>=0 && i<TAM && j>=0 && j<TAM){
                ...
                if(AcertosPossiveis==3&&ErrosPossiveis==4){
                    int Caso;
                    if(vet[linha-1][coluna]=='4'&&vet[linha+1][coluna]!='4'){
                        Caso = 1;
                    }
                    else if(vet[linha-1][coluna]=='4'&&vet[linha+1][coluna]=='4'){
                        Caso = 2;
                    }
                    else if(vet[linha-1][coluna]!='4'&&vet[linha+1][coluna]=='4'){
                        Caso = 3;
                    ...
                    if(Caso==1){
                        ...
                        for(int i=linha-1;i<=linha-1&&TamanhoEspiao2<6&&contador>0;i++){
                            for(int j=coluna+1;j<=coluna+3&&TamanhoEspiao2<6&&contador>0;j++){
                                if(i>=0 && i<TAM && j>=0 && j<TAM){
                                    if(vet[i][j]=='4'){
                                        if(guardar[i][j]==0){
                                            jogadas++;
                ...
                if(AcertosPossiveis==3&&ErrosPossiveis==4){
                    int Caso;
                    if(vet[linha][coluna-1]=='4'&&vet[linha][coluna+1]!='4'){
                        Caso = 1;
                    }
                    else if(vet[linha][coluna-1]!='4'&&vet[linha][coluna+1]=='4'){
                        Caso = 2;
                    }
                    if(Caso==1){
                        for(int j=coluna-1;j<=coluna-1&&TamanhoEspiao2<6&&contador>0;j++){
                        ...
                        for(int j=coluna-1;j<=coluna-1&&TamanhoEspiao2<6&&contador>0;j++){
                            for(int i=linha+1;i<=linha+3&&TamanhoEspiao2<6&&contador>0;i++){
                                if(i<0 || i>=TAM || j<0 || j>=TAM){
                                    ErrosPossiveis++;
                                }
                                if(i>=0 && i<TAM && j>=0 && j<TAM){
